...
class PPOHeadParameters(HeadParameters):
    def __init__(self, activation_function: str ='tanh', name: str='ppo_head_params',
                 num_output_head_copies: int = 1, rescale_gradient_from_head_by_factor: float = 1.0,
                 loss_weight: float = 1.0, dense_layer=None, policy_logstd_bias=0):
...
class PPOHeadWithPreDenseParameters(HeadParameters):
    def __init__(self, activation_function: str = 'tanh', name: str = 'ppo_head_w_pre_dense_params',
                 num_output_head_copies: int = 1, rescale_gradient_from_head_by_factor: float = 1.0,
                 loss_weight: float = 1.0, dense_layer=None, pre_dense_sizes=None,
                 pre_dense_activation_function='relu', policy_logstd_bias=0):
        super().__init__(parameterized_class_name="PPOHeadWithPreDense", activation_function=activation_function,
                         name=name, dense_layer=dense_layer, num_output_head_copies=num_output_head_copies,
                         rescale_gradient_from_head_by_factor=rescale_gradient_from_head_by_factor,
                         loss_weight=loss_weight)
...
class VHeadWithPreDenseParameters(HeadParameters):
    def __init__(self, activation_function: str ='relu', name: str='v_head_w_pre_dense_params',
                 num_output_head_copies: int = 1, rescale_gradient_from_head_by_factor: float = 1.0,
                 loss_weight: float = 1.0, dense_layer=None, initializer='normalized_columns',
                 output_bias_initializer=None, pre_dense_sizes=None, pre_dense_activation_function='relu'):
        super().__init__(parameterized_class_name="VHeadWithPreDense", activation_function=activation_function,
                         name=name, dense_layer=dense_layer, num_output_head_copies=num_output_head_copies,
                         rescale_gradient_from_head_by_factor=rescale_gradient_from_head_by_factor,
                         loss_weight=loss_weight)
        self.initializer = initializer
