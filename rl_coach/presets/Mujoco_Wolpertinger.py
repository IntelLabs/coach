...
agent_params.output_filter = \
    OutputFilter(
        action_filters=OrderedDict([
            # ('discretization', BoxDiscretization(num_bins_per_dimension=int(1e4)))
...
preset_validation_params.min_reward_threshold = 100
preset_validation_params.max_episodes_to_achieve_reward = 3000
preset_validation_params.reward_test_level = 'cartpole'
preset_validation_params.trace_test_levels = ['cartpole']
