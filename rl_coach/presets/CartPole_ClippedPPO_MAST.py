...
agent_params.algorithm.num_steps_between_copying_online_weights_to_target = EnvironmentSteps(64)
agent_params.algorithm.num_consecutive_playing_steps = EnvironmentSteps(64)
