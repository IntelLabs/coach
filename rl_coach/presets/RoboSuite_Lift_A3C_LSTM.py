...
from rl_coach.environments.environment import SingleLevelSelection
from rl_coach.architectures.head_parameters import PolicyHeadWithPreDenseParameters, VHeadWithPreDenseParameters
...
agent_params.input_filter.add_observation_filter('camera', 'stacking', ObservationStackingFilter(1, concat=False))
...
network.heads_parameters = [VHeadWithPreDenseParameters(pre_dense_sizes=[300, 200]),
                            PolicyHeadWithPreDenseParameters(pre_dense_sizes=[300, 200])]
