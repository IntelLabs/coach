...
class RobosuiteEnvironmentParameters(EnvironmentParameters):
    ...
    @property
    def path(self):
        return 'rl_coach.environments.robosuite_v1_environment:RobosuiteEnvironment'
...
class RobosuiteGoalBasedExpEnvironmentParameters(RobosuiteEnvironmentParameters):
    @property
    def path(self):
        return 'rl_coach.environments.robosuite_v1_environment:RobosuiteGoalBasedExpEnvironment'
